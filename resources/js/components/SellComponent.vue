...
<div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 ">
                <div class="ui label">Bank</div>
                <select class="select button form-control prompt " v-model="coiny" name="bank" >
        ...
        <div class="container">
            <div class="wrap">
                <button type="submit" data-toggle="modal" data-target="#exampleModalLong" :v-model="buy" >SELL</button>
        ...
        <div class="modal-dialog" role="document">
            ...
            <form class="form-style-9">
               ...
               <li>
                ...
                <li>
                <input type="text" name="field3" class="field-style field-full align-none" id="aconut_num" v-model='account'
    ...
    export default {
        ...
        methods:{
            ...
            myFunction: function() {
                ...
                newTotal=newTotal+(this.coins[this.coinx].sell_price*this.amt);
            ...
            formSubmit(e) {
                ...
                axios.post('/store', {
                    ...
                    bank:this.coiny,
                    amt:this.amt,
                    price:this.coins[this.coinx].sell_price,
                    stock:this.stock
