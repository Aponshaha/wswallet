...
<div>
        ...
        <div class="container">
            <div class="wrap">
                <button type="submit" data-toggle="modal" data-target="#exampleModalLong" :v-model="buy" >BUY</button>
    ...
    <div id="modal_2 " aria-hidden="true">
        ...
        <div class="modal3" aria-hidden="true">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <p>
                        You will have to send {{total}} tk to BIKASH [01671913223] or 
                        rocket [1234567890] num.
    ...
    export default {
        ...
        methods:{
            ...
            myFunction: function() {
               ...
               // total=parseInt(this.newtotal) + parseInt(this.fee);
